...
#define CFG_CHANGED_GSM_DOMAIN_FILE BIT(15)  //CONN-FY-FP7372_EAPSIM_Integration-00
...
#define MAX_WPS_VENDOR_EXT 10
	...
	/**
	 * gsm_domain_file - GSM home netwok domain configuration file
	 */
	char *gsm_domain_file;  //CONN-FY-FP7372_EAPSIM_Integration-00

	/**
	 * gsm_domain - Head of the gsm home network domain list
	 *
	 * This is the head for the list of all the GSM home network domains.
	 */
	struct wpa_gsm_domain *gsm_domain;  //CONN-FY-FP7372_EAPSIM_Integration-00
};

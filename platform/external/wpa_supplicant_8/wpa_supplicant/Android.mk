...
ifdef CONFIG_PCSC_SEMC
# SEMC interface for smartcards (USIM, GSM SIM)
L_CFLAGS += -DPCSC_FUNCS_SEMC
OBJS += src/utils/pcsc_funcs.c
# Support Multi scard
ifdef CONFIG_MULTI_SCARD
L_CFLAGS += -DMULTI_SCARD
endif
ifeq ($(strip $(SEMC_PLATFORM)),riogrande)
L_CFLAGS += -DPCSC_RIOGRANDE
endif
endif
